...
def custom_score_two(game, player):
    ...
    return float((myMoves/blankSpaces) - (oppMoves/blankSpaces)) * 100
...
def custom_score_three(game, player):
    ...
    if len(blankSpaces) < 16:
        return float(myMoves - oppMoves)
    elif len(blankSpaces) < 32:
        return float(myMoves - 2 * oppMoves)
    else:
        return float(myMoves - 3 * oppMoves)
...
class CustomPlayer:
    ...
    def minimax(self, game, depth, maximizing_player=True):
        ...
        if maximizing_player:
            ...
            for move in moves:
                ...
                score, placeHolder = self.minimax(clone, depth-1, False)
            ...
            for move in moves:
                clone = game.forecast_move(move)
                score, placeHolder = self.minimax(clone, depth-1, True)
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf"), maximizing_player=True):
        ...
        if maximizing_player:
            ...
            for move in moves:
                clone = game.forecast_move(move)
                score, placeHolder = self.alphabeta(clone, depth-1, alpha, beta, False)
            ...
            for move in moves:
                clone = game.forecast_move(move)
                score, placeHolder = self.alphabeta(clone, depth-1, alpha, beta, True)
